	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}					
					...
					\noindent \underbar{\textbf{UC6 – Pregledavanje tuđih zahtjeva}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC7 – Pregledavanje tuđih oglasa}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC8 – Pregledavanje vlastitih zahtjeva}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC9 – Pregledavanje vlastitih oglasa}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC10 – Pohranjivanje podataka o psu od strane vlasnika}}	
					...
					\noindent \underbar{\textbf{UC17 - Unos dogovorenih termina u kalendar od strane čuvara}}	
					...
					\noindent \underbar{\textbf{UC23 - Blokiranje korisnika koji narušava pravila sustava}}
