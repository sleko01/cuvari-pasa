	...
	\section{Funkcionalni zahtjevi}
			...
			\begin{packed_enum}
				...
				\begin{packed_enum}
					...
					\item Pregledavati objavljene zahtjeve i oglase te njihove pojedinosti (pasmina, dob, lokacija itd.)
				...
				\begin{packed_enum}
					...
					\begin{packed_enum}
						...
						\item Pregledavati pristigle ponude za čuvanje
						\item Stupiti u kontakt s čuvarom pasa
						\item Pregledavati trenutna čuvanja
				...
				\subsubsection{Opis obrazaca uporabe}					
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_item}
							...
							\item[4.a] Korisnik unosi ime psa koji već postoji na njegovom računu
							\item[] \begin{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Korisnik na na stranici s objavljenim oglasima prolazi kroz listu tuđih oglasa te pregledava podatke pojedinih oglasa  
					...
					\begin{packed_item}
						...
						\item  \textbf{Opis mogućih odstupanja:}
							...
							\item[4.b] Čuvar pasa odbija ponuđeni zahtjev
							\item[] \begin{packed_enum}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_item}
							...
							\item[4.a] Čuvar pasa odbija pronađeni odabir
							\item[] \begin{packed_enum}
								
								\item Daljnja suradnja između korisnika nije moguća
								
							\end{packed_enum}
							\item[4.b] Vlasnik pasa odbija ponuđeni oglas
					...
					\noindent \underbar{\textbf{UC17 - Ocjenjivanje usluge čuvanja}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC18 - Ocjenjivanje ponašanja psa}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC19 - Dodjeljivanje administratorske uloge korisniku}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC20 - Potvrđivanje stvorenog zahtjeva}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC21 - Potvrđivanje stvorenog oglasa}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC22 - Blokiranje korisnika}}
					\begin{packed_item}
